/* Win32 and HRESULT status codes.
 * Original text. Each name and value below is an interface constant recorded
 * from the public Windows CE headers; the wording, ordering and layout of this
 * file are ours and no upstream text is reproduced.
 */
...
#define MAKE_HRESULT(sev, fac, code) \
    ((HRESULT)(((unsigned long)(sev) << 31) | ((unsigned long)(fac) << 16) | \
               ((unsigned long)(code))))
#define HRESULT_FROM_WINERROR(x) \
    ((HRESULT)(((unsigned long)(x) & 0x0000FFFF) | 0x80070000u))
