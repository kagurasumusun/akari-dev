/*
 * Databaseapi.h -- Windows CE book-surface header of record (Akari API)
 *
 ...
 * record).  The pages in this book print "Header: databaseapi.h".
 *
...
#ifndef AKARI_DATABASEAPI_H
#define AKARI_DATABASEAPI_H
...
/* ee499852 PH_SPEEDDIAL_ENTRY: page print
 * typedef struct tagPH_SPEEDDIAL_ENTRY { DWORD StructSize; WCHAR pName[100]; WCHAR pNumber[100]; } PH_SPEEDDIAL_ENTRY;
...
/* ee499326 PHAddSpeedDialEntry: print `HRESULT PHAddSpeedDialEntry(
PH_SPEEDDIAL_ENTRY* pEntry
);`
 * (Windows Embedded CE 6.0 and later; Link Library: PhCommon.dll) */
AKARI_CE_IMPORT HRESULT PHAddSpeedDialEntry(PH_SPEEDDIAL_ENTRY *pEntry) AKARI_CE_NAME(PHAddSpeedDialEntry);

#endif /* _WIN32_WCE >= 0x0600 */
#endif /* AKARI_DATABASEAPI_H */
