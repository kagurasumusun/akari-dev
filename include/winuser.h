...
#define WS_EX_CAPTIONOKBTN   0x00000800
#define WS_EX_CLIENTEDGE     0x00000200
#define WS_EX_STATICEDGE     0x00020000
#define WS_EX_NODRAG         0x00000400
#define WS_EX_NOANIMATION    0x00004000
#define WS_EX_ABOVESTARTUP   0x00000020
#define WS_EX_INK            0x00000010
...
WINUSERAPI BOOL WINAPI PostQuitMessage(int nExitCode);
...
WINUSERAPI UINT WINAPI SetTimer(HWND hWnd, UINT nIDEvent, UINT uElapse, void *lpTimerFunc);
WINUSERAPI BOOL WINAPI KillTimer(HWND hWnd, UINT uIDEvent);
WINUSERAPI BOOL WINAPI RegisterClassW(const WNDCLASSW *lpWndClass);
...
WINUSERAPI BOOL WINAPI SetCapture(HWND hWnd);
...
WINUSERAPI DWORD WINAPI GetDoubleClickTime(VOID);
