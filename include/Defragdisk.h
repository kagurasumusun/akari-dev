/*
 * Defragdisk.h -- Windows CE book-surface header of record (Akari API)
 *
 ...
 * record).  The pages in this book print "Header: Defragdisk.h".
 *
...
#ifndef AKARI_DEFRAGDISK_H
#define AKARI_DEFRAGDISK_H
...
/* ms887931 DEFRAG_OPTIONS: page print
 * typedef struct _DEFRAG_OPTIONS { DWORD dwFatToUse; DWORD dwFlags;} DEFRAG_OPTIONS, *PDEFRAG_OPTIONS;
...
/* ms887957 DefragVolumeUI: print `VOID DefragVolumeUI(
HANDLEhVolume,HWNDhWnd);`
 * (Windows CE .NET 4.0 and later.; Link Library: Fatutil.dll) */
AKARI_CE_IMPORT VOID DefragVolumeUI(HANDLE hVolume, HWND hWnd) AKARI_CE_NAME(DefragVolumeUI);

#endif /* AKARI_DEFRAGDISK_H */
