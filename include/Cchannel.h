...
/* Audit 2026-09-16: the "Book surface: rdp" ActiveX/Mstsax.idl
 * inventory list that was here (duplicated twice) has been moved
 * to Discodlg.h, since every entry in it cites Header: Discodlg.h
 * -- see that file and docs/CHANGELOG-audit-2026-09-16.md. Nothing
 * here was compiled code (record-only comments), so nothing is
 * lost by relocating it. */
