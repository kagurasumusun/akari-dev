/*
 * Pcommctrl.h -- Windows CE book-surface header of record (Akari API).
 *
 ...
 * page ids cited per record).  Source book(s): m107-pcommctrl.
...
#ifndef AKARI_PCOMMCTRL_H
#define AKARI_PCOMMCTRL_H
...
/* ------------------------------------------------------------------
 * Book surface: m107-pcommctrl (tools/gen-book.py; page ids per record)
 * ------------------------------------------------------------------ */
/* ms902681 DPA (page print, compiled) */
typedef struct _DPA {
    int cp;
    void FAR* FAR* pp;
    HANDLE hheap;
