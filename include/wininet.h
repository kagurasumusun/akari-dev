...
#define INTERNET_OPTION_CALLBACK          2
#define INTERNET_OPTION_CONNECT_TIMEOUT   20
#define INTERNET_OPTION_CONNECT_RETRIES   21
#define INTERNET_OPTION_SEND_TIMEOUT      23
#define INTERNET_OPTION_RECEIVE_TIMEOUT   24
#define INTERNET_OPTION_DATA_RECEIVE_TIMEOUT 26
#define INTERNET_OPTION_DATA_SEND_TIMEOUT 27
#define INTERNET_OPTION_USER_AGENT        37
#define INTERNET_OPTION_USERNAME          43
#define INTERNET_OPTION_PASSWORD          44
...
#define INTERNET_STATUS_CONNECTING_TO_SERVER 12
#define INTERNET_STATUS_CONNECTED_TO_SERVER 13
#define INTERNET_STATUS_SENDING_REQUEST    14
#define INTERNET_STATUS_REQUEST_SENT       15
#define INTERNET_STATUS_RECEIVING_RESPONSE 16
#define INTERNET_STATUS_RESPONSE_RECEIVED  17
#define INTERNET_STATUS_CLOSING_CONNECTION 18
#define INTERNET_STATUS_CONNECTION_CLOSED  19
#define INTERNET_STATUS_HANDLE_CREATED     20
#define INTERNET_STATUS_HANDLE_CLOSING     21
#define INTERNET_STATUS_REQUEST_COMPLETE   50
#define INTERNET_STATUS_REDIRECT           60
...
#define ICU_BROWSER_MODE 0x00000002
...
#define MAX_GOPHER_HOST_NAME    128
...
WININETAPI BOOL WINAPI InternetAttemptConnect(DWORD dwReserved);
WININETAPI BOOL WINAPI InternetErrorDlg(HWND hWnd, HINTERNET hRequest, DWORD dwError,
...
WININETAPI DWORD WINAPI InternetCombineUrlW(LPCWSTR lpszBaseUrl, LPCWSTR lpszRelativeUrl,
    LPWSTR lpszBuffer, LPDWORD lpdwBufferLength, DWORD dwFlags);
WININETAPI DWORD WINAPI InternetCombineUrlA(LPCSTR lpszBaseUrl, LPCSTR lpszRelativeUrl,
    LPSTR lpszBuffer, LPDWORD lpdwBufferLength, DWORD dwFlags);
WININETAPI DWORD WINAPI InternetCanonicalizeUrlW(LPCWSTR lpszUrl, LPWSTR lpszBuffer,
    LPDWORD lpdwBufferLength, DWORD dwFlags);
WININETAPI DWORD WINAPI InternetCanonicalizeUrlA(LPCSTR lpszUrl, LPSTR lpszBuffer,
    LPDWORD lpdwBufferLength, DWORD dwFlags);
...
WININETAPI HINTERNET WINAPI InternetFindNextFileW(HINTERNET hFind, LPVOID lpvFindData);
WININETAPI HINTERNET WINAPI InternetFindNextFileA(HINTERNET hFind, LPVOID lpvFindData);
