 ...
 * values).  Both documented spellings ship: Rtccore.h (this file) and
 * Rtcerr.h (the return-value constants, included below).
 *
...
/* RTC_E_/RTC_S_ return values are documented under "Header:
 * Rtcerr.h" (ms931795 / ms912578) and live in Rtcerr.h, included
 * here so Rtccore.h consumers still see them. */
#include "Rtcerr.h"

/* RTCAU_ (ms931697): values printed on the page (Header: Rtccore.h). */
...
/* RTCCS_ (ms931725): values printed on the page (Header: Rtccore.h). */
#define RTCCS_FAIL_ON_REDIRECT                      0x00000002
#define RTCCS_FORCE_PROFILE                         0x00000001

/* RTCEF_ (ms931840): values printed on the page (Header: Rtccore.h). */
