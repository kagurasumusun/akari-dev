...
#ifndef WCE_MSHTMDBG_H
#define WCE_MSHTMDBG_H
#include "windef.h"
#include "winnt.h"
#include "wceunk.h"
#ifdef __cplusplus
...
WCE_IMPORT void WINAPI DbgExPerfEnable(BOOL fEnable) WCE_LINK(DbgExPerfEnable);
...
WCE_IMPORT PERFMETERTAG WINAPI DbgExMtLookupMeter(char * szTag) WCE_LINK(DbgExMtLookupMeter);
WCE_IMPORT long WINAPI DbgExMtGetMeterCnt(PERFMETERTAG mt, BOOL fExclusive) WCE_LINK(DbgExMtGetMeterCnt);
WCE_IMPORT long WINAPI DbgExMtGetMeterVal(PERFMETERTAG mt, BOOL fExclusive) WCE_LINK(DbgExMtGetMeterVal);
